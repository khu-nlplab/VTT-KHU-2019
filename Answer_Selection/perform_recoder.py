...
class PerformRecoder(object):
    ...
    def ckpt_file_path_generator(self, step):
        return os.path.join(self.model_params.ckpt_dir, 'top_result_saver_step-%d.ckpt' % step)
